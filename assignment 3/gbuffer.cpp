...

{
  ...
  glGenTextures( 1, &shadowMap ); // carter
  ...
  // depth
  //did they forget to put brackets on this for loop??
  for (int i=numTextures; i<GL_MAX_DRAW_BUFFERS; i++)
  ...
  // hunch: this generates a texture that is later associated with shadowMap by glFramebufferTexture
...

{
  ...
  //is this where the actual onscreen rendering occurs?
